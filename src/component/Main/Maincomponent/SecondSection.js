...
ewefwerwefwefewfsdwqdefew33q2weDwfwr2sadewrwsff3wrtt    
                <div className="row">
                <div className="col-md-4">
                <div className="placement">
                <div style={{float:"left"}} className="svg1">
                ...
                Mobile apps
                 ...
                 Stay on top of the markets with the Coinbase app for <a href="#"> Android or iOS </a>.
                 </p>
                 </div>
                 </div>
            ...
            <div className="col-md-5 neibouringimg">
                 
                  <div>
                      <img src="https://assets.coinbase.com/assets/coinbase-app.3b0bfd4cb6b7a7614c1e18472187f6b9.webp" alt="coinbase" style={{width:"140%"}}/>
